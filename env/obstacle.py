...
class ComplexObstacle3D(Obstacle3D):
    '''
        Implementation of 3D obstacle which consists of a composition of
        3D rectangular obstacles
    '''
    def __init__(self, bounds):
        self.obs = []
        for boundsx, boundsy, boundsz in bounds:
            self.obs.append(Obstacle3D(boundsx, boundsy, boundsz))
